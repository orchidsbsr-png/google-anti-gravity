...
const dict = {
    en: {
        ...
        'hero.eyebrow': 'Naliban Khatasu · Jubbal-Kotkhai · Himachal · 2,300m Above Sea Level',
        'hero.title1': 'From mountain air',
        'hero.title2': 'to your table.',
        'hero.sub': 'Naturally grown Himalayan fruits, handpicked only after your order, sourced directly from farming families and delivered fresh to your doorstep across India.',
        'hero.sub2': 'No middlemen. No cold-storage trading. No wholesale markets. Just genuine fruit from our orchards and trusted local farmers.',
        'hero.shop': 'Shop Fresh Fruits',
        'hero.story': 'Discover Our Story',
        'hero.scroll': 'Scroll',

        'origin.eyebrow': 'Our Origin',
        'origin.title1': 'Named after',
        'origin.title2': 'a village.',
        'origin.body': 'Naliban takes its name from Naliban Khatasu, a village nestled in the mountains of Jubbal-Kotkhai, Himachal Pradesh — a region known for premium apples, cherries and stone fruit, grown the traditional mountain way at roughly 2,300 metres. Up here the air is cooler, ripening is slower, and every fruit turns out sweeter and richer. What you taste isn’t one orchard alone: it’s our farm and the trusted farming families around us, growing naturally on healthy soil.',
        'origin.stat1': 'Years of orchard heritage',
        'origin.stat2': 'Altitude grown',
        'origin.stat3': 'Middlemen',
    ...
    hi: {
        ...
        'hero.eyebrow': 'नालीबन खताशु · जुब्बल-कोटखाई · हिमाचल · समुद्र तल से 2,300 मीटर',
        'hero.title1': 'पहाड़ों की हवा से',
        'hero.title2': 'आपकी थाली तक।',
        'hero.sub': 'प्राकृतिक रूप से उगाए गए हिमालयी फल — आपके ऑर्डर के बाद ही तोड़े गए, सीधे किसान परिवारों से, पूरे भारत में आपके द्वार तक ताज़ा पहुँचाए गए।',
        'hero.sub2': 'न बिचौलिये। न कोल्ड-स्टोरेज का व्यापार। न थोक मंडी। सिर्फ़ हमारे बगीचों और भरोसेमंद स्थानीय किसानों का असली फल।',
        'hero.shop': 'ताज़ा फल ख़रीदें',
        'hero.story': 'हमारी कहानी जानें',
        'hero.scroll': 'नीचे देखें',

        'origin.eyebrow': 'हमारी शुरुआत',
        'origin.title1': 'एक गाँव के',
        'origin.title2': 'नाम पर।',
        'origin.body': 'नालीबन नाम आया है नालीबन खताशु से — हिमाचल प्रदेश के जुब्बल-कोटखाई के पहाड़ों में बसा एक गाँव, जो बेहतरीन सेब, चेरी और गुठलीदार फलों और पारंपरिक पहाड़ी खेती के लिए जाना जाता है। लगभग 2,300 मीटर की ऊँचाई पर हवा ठंडी होती है, फल धीरे पकते हैं, और स्वाद अधिक मीठा और गहरा होता है। यह सिर्फ़ एक बगीचे की बात नहीं — यह हमारा खेत और आस-पास के भरोसेमंद किसान परिवार हैं, जो स्वस्थ मिट्टी पर प्राकृतिक खेती करते हैं।',
        'origin.stat1': 'बग़ीचों की विरासत के वर्ष',
        'origin.stat2': 'ऊँचाई पर उगाया',
        'origin.stat3': 'बिचौलिये',
