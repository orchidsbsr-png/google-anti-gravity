        ...
        <div className="legal-page">
            <div className="legal-container">
                ...
                <section id="terms">
                    ...
                    <p>This document is published in accordance with the provisions of Rule 3 (1) of the Information Technology (Intermediaries guidelines) Rules, 2011 that require publishing the rules and regulations, privacy policy and Terms of Use for access or usage of domain name https://nalibanfarms.in/ ('Website'), including the related mobile site and mobile application (hereinafter referred to as 'Platform').</p>
                    <p>The Platform is owned by Naliban Farms, a company incorporated under the Companies Act, 1956 with its registered office at CMP society, Kathasu, Jubbal ,Jubbal ,India (hereinafter referred to as ‘Platform Owner’, 'we', 'us', 'our').</p>
                    ...
                    <ul>
                        ...
                        <li>All disputes arising out of or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Jubbal and Himachal Pradesh.</li>
                ...
                <section id="refunds">
                    ...
                    <ul>
                        ...
                        <li>Naliban Farms does not accept cancellation requests for perishable items like flowers, eatables, etc. However, the refund / replacement can be made if the user establishes that the quality of the product delivered is not good.</li>
                        ...
                        <li>In case of any refunds approved by Naliban Farms, it will take 7 days for the refund to be processed to you.</li>
                    </ul>
                </section>
