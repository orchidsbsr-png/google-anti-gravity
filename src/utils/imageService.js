export const getProductImage = (productName, { variety } = {}) => {
    ...
    const imageMap = {
        ...
        'Pears': 'Red Bartlett.jpg',
        'Red Bartlett': 'Red Bartlett.jpg',
        'Red Bartlett Pear': 'Red Bartlett.jpg',
        'Packham': 'Packham.jpg',
        'Packham Pear': 'Packham.jpg',
        'Bergamot': 'Bergamot.jpg',
        'Bergamot Pear': 'Bergamot.jpg',
        'Tumba': 'Tumba.jpg',
        'Tumba Pear': 'Tumba.jpg',
